...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool C_SteamJet::SimulateAndRender(Particle *pInParticle, ParticleDraw *pDraw, float &sortKey)
{
	SteamJetParticle *pParticle = (SteamJetParticle*)pInParticle;
	...
	pParticle->m_flRoll += pParticle->m_flRollDelta * pDraw->GetTimeDelta();
