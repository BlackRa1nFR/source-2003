...
// Input  : &vSortOrigin - 
//-----------------------------------------------------------------------------
void CParticleEffect::GetSortOrigin( Vector &vSortOrigin )
{
	vSortOrigin = m_vSortOrigin;
...
void CParticleEffect::SetSortOrigin( const Vector &vSortOrigin )
{
	...
	m_ParticleEffect.EnlargeBBoxToContain( vSortOrigin );
}
...
// Output : float
//-----------------------------------------------------------------------------
float CSimpleEmitter::UpdateAlpha( SimpleParticle *pParticle, float timeDelta )
{
...
// Output : float
//-----------------------------------------------------------------------------
float CSimpleEmitter::UpdateScale( SimpleParticle *pParticle, float timeDelta )
{
...
//			timeDelta - 
//-----------------------------------------------------------------------------
Vector CSimpleEmitter::UpdateColor( SimpleParticle *pParticle, float timeDelta )
{
...
//			timeDelta - 
//-----------------------------------------------------------------------------
Vector CEmberEffect::UpdateColor( SimpleParticle *pParticle, float timeDelta )
{
	Vector	color;
...
float CFireSmokeEffect::UpdateAlpha( SimpleParticle *pParticle, float timeDelta )
{
...
Vector CFireParticle::UpdateColor( SimpleParticle *pParticle, float timeDelta )
{
	for ( int i = 0; i < 3; i++ )
	{
	...
	return CSimpleEmitter::UpdateColor( pParticle, timeDelta );
}
