...
!MESSAGE 
!MESSAGE NMAKE /f "hlds_gui.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "hlds_gui.mak" CFG="ServerBrowser - Win32 Debug"
!MESSAGE 
...
# ADD CPP /nologo /MT /W3 /GR /GX /O2 /I "..\public" /I "..\..\public" /I "..\common" /I "..\..\common" /I "..\..\vgui2\controls" /I "..\..\vgui2\include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "SERVERBROWSER_EXPORTS" /YX /FD /c
...
"..\..\..\Platform\Server\Server.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	if exist ..\..\..\Platform\Server\Server.dll attrib -r ..\..\..\Platform\Server\Server.dll 
	if exist $(TargetPath) copy $(TargetPath) ..\..\..\Platform\Server\Server.dll 
