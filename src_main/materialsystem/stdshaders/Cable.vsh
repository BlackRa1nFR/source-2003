...
;
;	c90		= Directional light direction // FIXME
;------------------------------------------------------------------------------
...
dp3		$lightDirection.x, $s, c90 ; FIXME
dp3		$lightDirection.y, $t, c90 ; FIXME
dp3		$lightDirection.z, $r, c90 ; FIXME
...
add		oD1, $lightDirection, $cHalf	; + 0.5 
