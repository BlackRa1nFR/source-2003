...
public:
	...
	virtual bool NeedsFrameBufferTexture( IMaterialVar **params ) const { return false; }
	virtual void SetShaderDLLHandle( int hShaderDLL );
	virtual int GetShaderDLLHandle( ) const;
...
protected:
	...
	void SetAmbientCubeDynamicStateFixedFunction( );
