...
//-----------------------------------------------------------------------------
#define INTERFACEVERSION_STATICPROPMGR_CLIENT		"StaticPropMgrClient001"
#define INTERFACEVERSION_STATICPROPMGR_SERVER		"StaticPropMgrServer001"
...
public:
	...
	virtual void	ComputePropOpacity( const Vector &viewOrigin ) = 0;
