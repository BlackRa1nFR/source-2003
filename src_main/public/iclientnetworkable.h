...
enum ShouldTransmitState_t
{
	...
	SHOULDTRANSMIT_STAY,	// Called each frame the entity continues to be transmitted by the server.
...
public:
	...
	virtual void			ReceiveMessage( const char *msgname, int length, void *data ) = 0;
