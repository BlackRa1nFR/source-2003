...
inline void Vector3DMultiplyPosition( const VMatrix& src1, const Vector src2, Vector& dst )
{
	dst[0] = src1[0][0] * src2[0] + src1[0][1] * src2[1] + src1[0][2] * src2[2] + src1[0][3];
	dst[1] = src1[1][0] * src2[0] + src1[1][1] * src2[1] + src1[1][2] * src2[2] + src1[1][3];
	dst[2] = src1[2][0] * src2[0] + src1[2][1] * src2[1] + src1[2][2] * src2[2] + src1[2][3];
}
...
inline void MatrixTransformAxisAlignedPlane( const VMatrix &src, int nDim, float flSign, float flDist, cplane_t &outPlane )
{
	...
	// This sould read outPlane.dist += DotProduct( outPlane.normal, src.GetTranslation );
