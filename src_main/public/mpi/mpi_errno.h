...
#define MPI_ERR_NO_MEM		34      /* for consistency with MPI 2 */
...
#define MPI_ERR_BASE		46		/* invalid base address */
#define MPI_ERR_SIZE		47		/* */
#define MPI_ERR_DISP		48		/* */
#define MPI_ERR_LOCKTYPE	49		/* */
#define MPI_ERR_ASSERT		50		/* */
#define MPI_ERR_RMA_CONFLICT	51	/* */
#define MPI_ERR_RMA_SYNC	52		/* */
