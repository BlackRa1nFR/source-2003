...
BEGIN_DATADESC( CPlayer_Control )
	...
	DEFINE_FIELD( CPlayer_Control, m_bActive, FIELD_BOOLEAN ),
	DEFINE_FIELD( CPlayer_Control,	m_nSaveFOV,					FIELD_INTEGER ),
	DEFINE_FIELD( CPlayer_Control,	m_vSaveOrigin,				FIELD_POSITION_VECTOR ),
	DEFINE_FIELD( CPlayer_Control,	m_vSaveAngles,				FIELD_VECTOR ),
	DEFINE_FIELD( CPlayer_Control,	m_nSaveMoveType,			FIELD_INTEGER ),
	DEFINE_FIELD( CPlayer_Control,	m_nSaveMoveCollide,			FIELD_INTEGER ),
	DEFINE_FIELD( CPlayer_Control,	m_vSaveViewOffset,			FIELD_VECTOR ),
	DEFINE_FIELD( CPlayer_Control,	m_pSaveWeapon,				FIELD_CLASSPTR ),
	DEFINE_FIELD( CPlayer_Control,	m_nPClipTraceDir,			FIELD_INTEGER),
	DEFINE_FIELD( CPlayer_Control,	m_flCurrMinClipDist,		FIELD_FLOAT),
	DEFINE_FIELD( CPlayer_Control,	m_flLastMinClipDist,		FIELD_FLOAT),

	// Inputs
	DEFINE_INPUTFUNC( CPlayer_Control, FIELD_VOID, "Activate", InputActivate ),
	DEFINE_INPUTFUNC( CPlayer_Control, FIELD_VOID, "Deactivate", InputDeactivate ),
	DEFINE_INPUTFUNC( CPlayer_Control, FIELD_FLOAT, "SetThrust", InputSetThrust ),
	DEFINE_INPUTFUNC( CPlayer_Control, FIELD_FLOAT, "SetSideThrust", InputSetSideThrust ),
...
float CPlayer_Control::PlayerControlClipDistance(void)
{
	...
	if (tr.fraction < 1.0)
	{
		...
		char	  	   m_chTextureType = pSurface->gameMaterial;
...
// Purpose:
//------------------------------------------------------------------------------
bool CPlayer_Control::ShouldTransmit( const edict_t *recipient, 
