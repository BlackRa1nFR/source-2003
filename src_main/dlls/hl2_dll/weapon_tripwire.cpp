...
BEGIN_DATADESC( CWeapon_Tripwire )
	...
	DEFINE_FIELD( CWeapon_Tripwire, m_bNeedReload, FIELD_BOOLEAN ),
	DEFINE_FIELD( CWeapon_Tripwire, m_bClearReload, FIELD_BOOLEAN ),
	DEFINE_FIELD( CWeapon_Tripwire, m_bAttachTripwire, FIELD_BOOLEAN ),

	// Function Pointers
	DEFINE_FUNCTION( CWeapon_Tripwire, TripwireTouch ),
