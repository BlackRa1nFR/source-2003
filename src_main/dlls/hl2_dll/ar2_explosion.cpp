...
BEGIN_DATADESC( AR2Explosion )
	...
	DEFINE_AUTO_ARRAY( AR2Explosion, m_szMaterialName, FIELD_CHARACTER ),
...
BEGIN_DATADESC( CEnvAR2Explosion )
	DEFINE_INPUTFUNC(CEnvAR2Explosion, FIELD_VOID, "Explode", InputExplode),
	DEFINE_KEYFIELD(CEnvAR2Explosion, m_iszMaterialName, FIELD_STRING, "material"),
END_DATADESC()
