...
{
	// Models
	engine->PrecacheModel( BUFF_STATION_HUMAN_MODEL );
	engine->PrecacheModel( BUFF_STATION_ALIEN_MODEL );
	
	// Build models
	engine->PrecacheModel( BUFF_STATION_HUMAN_ASSEMBLING_MODEL );
	engine->PrecacheModel( BUFF_STATION_ALIEN_ASSEMBLING_MODEL );
