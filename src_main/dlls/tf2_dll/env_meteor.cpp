...
BEGIN_DATADESC( CEnvMeteorSpawner )
	...
	DEFINE_KEYFIELD( CEnvMeteorSpawner, m_SpawnerShared.m_bSkybox, FIELD_INTEGER, "SpawnInSkybox" ),
...
BEGIN_DATADESC( CShootingStarSpawner )
	...
	DEFINE_KEYFIELD_NOT_SAVED( CShootingStarSpawner, m_bSkybox, FIELD_INTEGER, "SpawnInSkybox" ),
