...
BEGIN_DATADESC( CPointHurt )
	...
	DEFINE_KEYFIELD( CPointHurt, m_flRadius, FIELD_FLOAT, "DamageRadius" ),
	DEFINE_KEYFIELD( CPointHurt, m_nDamage, FIELD_INTEGER, "Damage" ),
	DEFINE_KEYFIELD( CPointHurt, m_flDelay, FIELD_FLOAT, "DamageDelay" ),
	DEFINE_KEYFIELD( CPointHurt, m_bitsDamageType, FIELD_INTEGER, "DamageType" ),
	DEFINE_KEYFIELD( CPointHurt, m_strTarget, FIELD_STRING, "DamageTarget" ),
	
	// Function Pointers
	DEFINE_FUNCTION( CPointHurt, HurtThink ),

	// Inputs
	DEFINE_INPUTFUNC( CPointHurt, FIELD_VOID, "TurnOn", InputTurnOn ),
	DEFINE_INPUTFUNC( CPointHurt, FIELD_VOID, "TurnOff", InputTurnOff ),
	DEFINE_INPUTFUNC( CPointHurt, FIELD_VOID, "Toggle", InputToggle ),
	DEFINE_INPUTFUNC( CPointHurt, FIELD_VOID, "Hurt", InputHurt ),

	DEFINE_FIELD( CPointHurt, m_pActivator, FIELD_EHANDLE ),
