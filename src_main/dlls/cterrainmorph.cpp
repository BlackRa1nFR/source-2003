...
BEGIN_DATADESC( CTerrainMorph )
	...
	// Function Pointers
	DEFINE_FUNCTION( CTerrainMorph, MorphThink ),

	DEFINE_INPUTFUNC( CTerrainMorph, FIELD_VOID, "BeginMorph", InputBeginMorph ),

	// quiet down classcheck
	// DEFINE_FIELD( CTerrainMorph, m_Params, CTerrainMorphParams ),
	DEFINE_KEYFIELD( CTerrainMorph, m_Params.m_flStartRadius, FIELD_FLOAT, "startradius" ),
	DEFINE_KEYFIELD( CTerrainMorph, m_Params.m_flGoalRadius, FIELD_FLOAT, "goalradius" ),
	DEFINE_KEYFIELD( CTerrainMorph, m_Params.m_flDuration, FIELD_FLOAT, "duration" ),
	DEFINE_KEYFIELD( CTerrainMorph, m_Params.m_flFraction, FIELD_FLOAT, "fraction" ),

	DEFINE_FIELD( CTerrainMorph, m_iIterations, FIELD_INTEGER ),
