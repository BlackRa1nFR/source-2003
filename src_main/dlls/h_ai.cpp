...
//-----------------------------------------------------------------------------
Vector VecCheckToss( CBaseEntity *pEntity, Vector vecSpot1, Vector vecSpot2, float flHeightMaxRatio, float flGravityAdj, bool bRandomize )
{
	trace_t			tr;
...
// 
Vector VecCheckThrow ( CBaseEntity *pEdict, const Vector &vecSpot1, Vector vecSpot2, float flSpeed, float flGravityAdj )
{
	float			flGravity = sv_gravity.GetFloat() * flGravityAdj;
...
//	NDebugOverlay::Line( vecSpot1, vecApex, 0, 255, 0, true, 2.0 );
//	NDebugOverlay::Line( vecApex, vecSpot2, 0, 255, 0, true, 2.0 );
