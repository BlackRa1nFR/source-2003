...
BEGIN_DATADESC( CTextureToggle )
	...
	DEFINE_INPUTFUNC( CTextureToggle, FIELD_VOID, "IncrementTextureIndex", InputIncrementBrushTexIndex ),
	DEFINE_INPUTFUNC( CTextureToggle, FIELD_INTEGER, "SetTextureIndex", InputSetBrushTexIndex ),
