...
BEGIN_DATADESC( CAreaPortal )
	...
	DEFINE_KEYFIELD( CAreaPortal, m_portalNumber, FIELD_INTEGER, "portalnumber" ),
	DEFINE_FIELD( CAreaPortal, m_state, FIELD_INTEGER ),

	// Inputs
	DEFINE_INPUTFUNC( CAreaPortal, FIELD_VOID, "Open",  InputOpen ),
	DEFINE_INPUTFUNC( CAreaPortal, FIELD_VOID, "Close", InputClose ),
	DEFINE_INPUTFUNC( CAreaPortal, FIELD_VOID, "Toggle",  InputToggle ),

	// TODO: obsolete! remove	
	DEFINE_INPUTFUNC( CAreaPortal, FIELD_VOID, "TurnOn",  InputClose ),
	DEFINE_INPUTFUNC( CAreaPortal, FIELD_VOID, "TurnOff", InputOpen ),
...
bool CAreaPortal::UpdateVisibility( const Vector &vOrigin )
{
...
bool CAreaPortal::ShouldTransmit( const edict_t *recipient, const void *pvs, int clientArea )
{
