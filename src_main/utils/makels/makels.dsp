...
# PROP Scc_ProjName ""$/Src/utils/makels", GDGBAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
TargetPath=.\Release\makels.exe
InputPath=.\Release\makels.exe
SOURCE="$(InputPath)"

"..\..\..\bin\makels.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	if exist ..\..\..\bin\makels.exe attrib -r ..\..\..\bin\makels.exe 
...
# Begin Custom Build - Copy to ..\..\..\bin
TargetPath=.\Debug\makels.exe
InputPath=.\Debug\makels.exe
SOURCE="$(InputPath)"
