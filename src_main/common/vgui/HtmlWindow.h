...
{
public:
	HtmlWindow(vgui::IHTMLEvents *events, vgui::VPANEL c, HWND parent);
	virtual ~HtmlWindow();
...
// IE DOESN'T support inplaceobjectwindowless
//	IOleInPlaceObjectWindowless * m_oleInPlaceObject;
	IViewObject * m_viewObject;

	HWND m_parent; // the "main" IE window, a temp window
