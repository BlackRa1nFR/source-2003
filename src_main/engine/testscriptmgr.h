...
public:
	...
	void		SetWaitCheckPoint( const char *pCheckPointName );
...
private:
	...
	friend void Test_Wait();
	friend void Test_RunFrame();
...
private:
	...
	friend void Test_RunFrame();
	friend void Test_StartLoop();
	friend void Test_LoopCount();
	friend void Test_LoopForNumSeconds();
};
