...
IMPLEMENT_NETWORKCLASS_ALIASED( SingleplayRules, DT_SingleplayRules )

BEGIN_NETWORK_TABLE( CSingleplayRules, DT_SingleplayRules )
END_NETWORK_TABLE()
	...
	//=========================================================
	//=========================================================
	bool CSingleplayRules :: ClientConnected( edict_t *pEntity, const char *pszName, const char *pszAddress, char szRejectReason[ 128 ] )
	{
		return true;
	}
