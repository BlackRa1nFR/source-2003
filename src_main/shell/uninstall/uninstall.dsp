...
# ADD CPP /nologo /MT /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_USRDLL" /FR /Yu"stdafx.h" /FD /c
...
# Begin Custom Build
TargetPath=.\Release\uninstall.dll
InputPath=.\Release\uninstall.dll
SOURCE=$(InputPath)

"d:\quiver\uninstall.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy "$(TargetPath)" d:\quiver
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /Zi /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_USRDLL" /FR /Yu"stdafx.h" /FD /c
...
# Begin Custom Build
TargetPath=.\Debug\uninstall.dll
InputPath=.\Debug\uninstall.dll
SOURCE=$(InputPath)
