...
private:
	...
	static void			GetNewTextureMatches( const char * pszOldName, ITextureList * pMatchList );
	...
	static void			RescaleFaceTexture( CMapFace * pFace, IEditorTexture * pOldTexture, IEditorTexture * pNewTexture );
