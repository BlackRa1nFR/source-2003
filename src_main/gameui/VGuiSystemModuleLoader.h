...
public:
	...
	void LoadPlatformModules(CreateInterfaceFn *factorylist, int factorycount, bool useSteamModules);
...
private:
	...
	void InitializeAllModules(CreateInterfaceFn *factorylist, int factorycount);
